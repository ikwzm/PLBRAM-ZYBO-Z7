...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_bram_ctrl_0_BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins system_ila_0/SLOT_0_BRAM]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_csr_M01_AXI [get_bd_intf_pins axi_bram_ctrl_0/S_AXI] [get_bd_intf_pins axi_interconnect_csr/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_interconnect_csr_M01_AXI] [get_bd_intf_pins axi_interconnect_csr/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_interconnect_csr_M01_AXI]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins LED4_AXI_0/ARESETn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LED4_AXI_0/ACLOCK] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_interconnect_csr/ACLK] [get_bd_pins axi_interconnect_csr/M00_ACLK] [get_bd_pins axi_interconnect_csr/M01_ACLK] [get_bd_pins axi_interconnect_csr/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs LED4_AXI_0/CSR/CSR] -force
