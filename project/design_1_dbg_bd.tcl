...
connect_bd_intf_net -intf_net [get_bd_intf_nets processing_system7_0_M_AXI_GP0] [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net LED4_AXI_0_LED [get_bd_ports LED] [get_bd_pins LED4_AXI_0/LED] [get_bd_pins system_ila_0/probe0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets LED4_AXI_0_LED]
